...
from quof.widgets import QBasePushButton
...
class QBaseTabWidget(QFrame):
    ...
    def addTab(self, text: QText | str, widget: QWidget) -> None:
    ...
    def setTabText(self, index: int, text: QText | str) -> None:
        self._buttons[index].setTranslatableText(text)
